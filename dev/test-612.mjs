...
ok(sw.includes("const CACHE_NAME = 'sidecut-shell-v61.2';"), 'sw.js cache = sidecut-shell-v61.2');
const head = src.indexOf("version: '61.2'");
ok(head !== -1 && head < src.indexOf("version: '61.1'"), 'CHANGELOG head entry is 61.2');
